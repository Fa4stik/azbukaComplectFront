...
const Advantages = () => {
	...
	<li>
		...
		<p>
        Мы всегда готовы предоставить точный расчет стоимости работ и материалов для каждого проекта. Это обеспечивает прозрачность и позволяет клиентам планировать свой бюджет, не беспокоясь о неожиданных расходах
		</p>
	</li>
	<li>
		<h2>04</h2>
    ...
    <li>
		...
		<p>
        Компания использует только высококачественные материалы и современные технологии производства, чтобы обеспечить продукты высокой прочности и долговечности. 
        </p>
	</li>
</ul>
</section>
