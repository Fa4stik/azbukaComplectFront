        ...
        <div className="container-footer w-container">
            <div className="w-row">
                <div className="footer-column w-clearfix w-col w-col-4">
                    <img src={logogreen} alt="" width="150"
                            ...
                            <div className="w-row">
                                <div className="w-col w-col-7 w-col-small-6 w-col-tiny-7">
                                    ...
                                    <p className="footer-links">
                                        ...
                                        <a target="_blank" onClick={() => navigation('/glass/home')}>
                                            <span className="footer-link">Стекло для дома<br/></span>
                                        </a>
                                        <a target="_blank" onClick={() => navigation('/glass/business')}>
                                            <span className="footer-link">Стекло для бизнеса<br/></span>
                                        </a>
                                        <a target="_blank" onClick={() => navigation('/gallery/works')}>
                                ...
                                <div className="w-col w-col-5 w-col-small-6 w-col-tiny-5">
                                    ...
                                    <p className="footer-links">
                                        <span className="footer-link">
                                            <a href="https://yandex.ru/maps/org/abc_siberian_glass/215911119981/?ll=65.668419%2C57.120602&z=16">
                                                г.Тюмень, ул. Тополиная, д.6, офис 301</a>
                                            <br/>
                                        </span>
                                    </p>
                        ...
                        <div className="column-center-mobile w-col w-col-4">
                            ...
                            <p className="footer-description">
                                <strong className="link-email-footer">
                                    <a href="mailto:prokofiev@azbuka-prom.ru">prokofiev@azbuka-prom.ru</a>
                                </strong>
                                <br/>
                                <a href="tel:+79612083998"> +7 (961) 208 39 98</a>
                            </p>
